...
route.get('/:id?', function (req, res, next) {
    if (req.params.id) {
        ...
        supplier.getAllSupplier(function (err, row) {
...
route.delete('/:id', function (req, res, next) {
    ...
    supplier.deleteSupplierById(req.params.id, function (err, row) {
        if (err) {
            res.json(err);
        }
        else {
...
route.put('/:id', function (req, res, next) {
    ...
    supplier.updateSupplier(req.params.id, req.body, function (err, row) {
