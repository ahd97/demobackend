...
var sales_return = {
    ...
    updateSales_Return:function(id,sales_return,callback)
    {
      ...
      console.log(id);
      return  db.query("update Sales_Return set Sales_return_date=? where Sales_return_id=?",[sales_return.Sales_return_date,id],callback);
    },
    
    addSales_Return:function(sales_return,callback){
       return db.query("insert into Sales_Return(Sales_return_id,Sales_return_date) values(?,?)",[null,sales_return.Sales_return_date],callback);
    }
